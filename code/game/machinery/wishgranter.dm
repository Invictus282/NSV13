...
/obj/machinery/wish_granter/attack_hand(mob/living/carbon/user)
	...
	if(charges <= 0)
		...
		to_chat(user, "You speak.  [pick("I want the ship to disappear","Humanity is corrupt, mankind must be destroyed","I want to be rich", "I want to rule the world","I want immortality.")].  The Wish Granter answers.")
