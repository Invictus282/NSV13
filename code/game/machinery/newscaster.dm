...
/datum/newscaster/feed_network/New()
	CreateFeedChannel("Ship Announcements", "NSV13", 1)
...
/obj/machinery/newscaster
	name = "newscaster"
	desc = "A standard Nanotrasen-licensed newsfeed handler for use in corporate workspaces. All the news you absolutely have no use for, in one place!"
...
/obj/item/newspaper
	name = "newspaper"
	desc = "An issue of Vicker News Weekly, the company newspaper by Nanotrasen subsidiary VICKER Media."
...
/obj/item/newspaper/attack_self(mob/user)
	if(ishuman(user))
		...
		switch(screen)
			if(0) //Cover
				dat+="<DIV ALIGN='center'><B><FONT SIZE=6>Vicker News Weekly</FONT></B></div>"
