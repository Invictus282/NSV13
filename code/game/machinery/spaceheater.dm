...
/obj/machinery/space_heater
	...
	name = "space heater"
	desc = "Made by Space Amish using traditional space techniques, this heater/cooler is guaranteed not to set the ship on fire. Warranty void if used in engines."
	max_integrity = 250
